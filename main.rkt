...
(define-metafunction RC
  interpret-stack : e Σ σ -> rc-result
  [(interpret-stack rc-result Σ σ) rc-result]
  [(interpret-stack (raises e) Σ σ) stuck]
  [(interpret-stack x Σ σ) (lookup Σ x)])
